...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**ನೀವು ನಮ್ಮ ಬ್ಯಾಕ್-ಅಪ್ ಚಾನೆಲ್ ನಲ್ಲಿ ಇಲ್ಲಿರುವುದಿಲ್ಲ, ಆದ್ದರಿಂದ ನೀವು ಚಲನಚಿತ್ರ ಫೈಲ್‌ಗಳನ್ನು ಪಡೆಯಲಾಗುವುದಿಲ್ಲ...\n\nಚಲನಚಿತ್ರ ಫೈಲ್‌ಗಳನ್ನು ಬಯಸುವಿರಿದ್ದರೆ, ಕೆಳಗಿನ '❆ ನಮ್ಮ ಬ್ಯಾಕ್-ಅಪ್ ಚಾನೆಲ್‌ಗೆ ಸೇರಿ ❆' ಬಟನ್‌ಗೆ ಕ್ಲಿಕ್ ಮಾಡಿ ನಮ್ಮ ಬ್ಯಾಕ್-ಅಪ್ ಚಾನೆಲ್‌ಗೆ ಸೇರಿ, ನಂತರ '↻ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ' ಬಟನ್‌ಗೆ ಕ್ಲಿಕ್ ಮಾಡಿ...\n\nನಂತರ ನೀವು ಚಲನಚಿತ್ರ ಫೈಲ್‌ಗಳನ್ನು ಪಡೆಯುವಿರಿ...**",
